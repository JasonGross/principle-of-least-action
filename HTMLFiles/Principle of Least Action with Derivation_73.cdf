...
NotebookDataLength[      3833,         94]
NotebookOptionsPosition[      4327,         89]
NotebookOutlinePosition[      4809,        109]
CellTagsIndexPosition[      4766,        106]
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`a$$ = 0.6600000000000001, $CellContext`b$$ =
    ...
    Typeset`size$$ = {360., {103., 106.8976371229964}}, Typeset`update$$ = 0, 
...
$CellContext`t}}, {$CellContext`t, $CellContext`ymin$$, $CellContext`ymax$$}, 
     ...
     ImageSizeCache->{642., {131.634033203125, 137.365966796875}},
   ...
   Deployed->True,
   StripOnInput->False],
  Manipulate`InterpretManipulate[1]]], "Output",ExpressionUUID->"be44c259-\
f466-448b-b0ac-3890dbc83c04"]
},
Visible->True,
...
ExpressionUUID->"b16dc14b-725b-4cfa-a61c-6bdf5e8471bc"
]
...
(*NotebookFileOutline
Notebook[{
Cell[1488, 33, 2835, 54, 32, "Output",ExpressionUUID->"be44c259-f466-448b-b0ac-3890dbc83c04"]
}
]
*)
...
(* NotebookSignature owTOc0vu6wjTIBgeijZyCP6Z *)
