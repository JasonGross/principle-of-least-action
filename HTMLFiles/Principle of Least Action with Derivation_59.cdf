...
{$CellContext`\[Theta], 0, $CellContext`\[Theta]max$}, 
   ...
   Deployed->True,
   StripOnInput->False],
  Manipulate`InterpretManipulate[1]]], "Output",ExpressionUUID->"6ccd4263-\
9fdc-4419-b8e0-be50a8faf2d3"]
},
Visible->True,
...
ExpressionUUID->"265aa88d-73af-4ddd-a628-f452ee68667d"
]
...
(*NotebookFileOutline
Notebook[{
Cell[1488, 33, 3556, 67, 32, "Output",ExpressionUUID->"6ccd4263-9fdc-4419-b8e0-be50a8faf2d3"]
}
]
*)
...
(* NotebookSignature gxpCduNEW#eR2A11dN55VdiC *)
